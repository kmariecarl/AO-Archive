...
#example usage: kristincarlson~ python monetaryAccess_Transit.py -taccess /Users/kristincarlson/Dropbox/Bus-Highway/Task2/
# TestScenarios/mnpass_crnt_xpres/Post_process_access/Access_Results_Avg/mnpass_crnt_xpres_merge_avg.csv -fare 325 -vot 0
# -field cost -fname transit16_cost_access
